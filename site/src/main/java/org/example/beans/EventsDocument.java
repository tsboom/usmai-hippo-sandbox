...
@HippoEssentialsGenerated(internalName = "gogreen:eventsdocument")
@Node(jcrType="gogreen:eventsdocument")
public class EventsDocument extends HippoDocument {

    /**
     * The document type of the events document.
     */
    public final static String DOCUMENT_TYPE = "gogreen:eventsdocument";
    ...
    private final static String END_DATE = "gogreen:enddate";
     ...
     * @return the end date
     */
    @HippoEssentialsGenerated(internalName = "gogreen:enddate")
